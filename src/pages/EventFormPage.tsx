    ...
    <div className="bg-bg-app min-h-dvh w-full">
      ...
      <div className="mx-auto flex w-full max-w-270 flex-col gap-10 px-2 pt-16 pb-24">
        <div className="flex flex-col gap-4 text-[24px] font-semibold">
          <span className="text-fg-primary">{isDetailMode ? "행사 상세 조회" : "행사 등록"}</span>
          <div className="tracking-brand mb-2 text-[16px] text-[#f3f3f3]">
            {isDetailMode ? "행사 정보를 확인합니다." : "행사 정보를 등록합니다."}
        ...
        <div className="flex flex-col gap-12">
          <section className="flex flex-col gap-4">
            <h2 className="text-fg-secondary text-[18px] font-semibold">기본정보</h2>
            <EventBaseInfo
              value={baseInfoForm}
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-fg-secondary text-[18px] font-semibold">모집정보</h2>
            <EventRecruitInfo value={eventRecruitForm} onChange={handleRecruitInfoChange} />
          </section>

          <section className="flex flex-col gap-4">
            <h2 className="text-fg-secondary text-[18px] font-semibold">운영대상</h2>
            <EventTargetInfo value={eventTargetForm} onChange={handleTargetInfoChange} />
          </section>

          <section className="flex flex-col gap-4">
            <h2 className="text-fg-secondary text-[18px] font-semibold">상세정보</h2>
            <EventDetailInfo value={eventDetailForm} onChange={handleDetailInfoChange} />
          </section>
          ...
          {isDetailMode ? (
            <div className="flex items-center justify-center gap-2 pt-2">
              <Button
                disabled
                className="h-14 min-w-32 rounded-none border-[#bcbcbc] bg-[#1f96df] text-[15px] font-semibold text-white hover:bg-[#1f96df]"
              >
                저장
              </Button>
              <Button
